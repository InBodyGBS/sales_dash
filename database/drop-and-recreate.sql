-- ⚠️ WARNING: This will DELETE ALL DATA in sales_data and upload_history tables!
-- Only run this if you want to start fresh or if the table structure needs to be recreated.
