...
-- Used for Japan, China and other entities (excluding HQ, USA, BWA, Healthcare, Korot, Vietnam)
...
CREATE TABLE IF NOT EXISTS item_mapping (
    ...
    CONSTRAINT valid_entity_item_mapping CHECK (entity IN ('HQ', 'USA', 'BWA', 'Vietnam', 'Healthcare', 'Korot', 'Japan', 'China'))
);
...
COMMENT ON TABLE item_mapping IS 'Maps Entity + Item Number to fg_classification, category, model, product for Japan, China and other entities';
